...
//Uint32 *buffer = new Uint32[SCREEN_WIDTH*SCREEN_HEIGHT];
 ...
 //0xFF = 255 za baitovete tam

   // i chetirete baita sa = na FF

/* for(int i = 0; i < SCREEN_WIDTH*SCREEN_HEIGHT; i++) {
 buffer[i] = 0xFFFF0000;   // RedGreenBlueAplha, 00 = ne za cveta, FF e da;
...
SDL_Quit();
    ...
    void Screen::boxBlur() {
    //Swam the buffers, so pixel is in m_buffer2 and we are drawing to m_buffer1.
